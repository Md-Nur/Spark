...
const Student = ({ params }) => {
  ...
  return (
    <div className="hero min-h-screen bg-base-200 w-full">
      <Head>
        <title>{student.data?.name} - Spark</title>
        <meta
          name="description"
          content={`Profile of ${student.data?.name} of the department of Electrical and Electronic Engineering, University of Rajshahi. Rajshahi, Bangladesh.`}
          key="desc"
        />
      </Head>
